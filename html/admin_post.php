...
$get_search = get_valid_search_criteria_for_admin($db, $display_order, $language_type, $user_id);
// 検索条件に当てはまる記事を取得
$articles = get_searched_articles($db, $get_search['display_order'], $get_search['language_type'], $get_search['user_id']);
